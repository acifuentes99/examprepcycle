...
* */
    ...
    insertph4: function(start, tzone, name){
        ...
        function(err, response) {
            ...
            if(response){ 
                itemsProcceced++;
                if(itemsProcceced == that.certItems.length) that.next.redirect('/done');
                console.log('done!'); 
            }
        });
    }
